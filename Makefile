...
render.o: render.c render.h ambiente.h utils.h barco.h
	gcc -c -g $^
...
menu.o: menu.c menu.h utils.h render.h
	gcc -c -g $^

ambiente.o: ambiente.c ambiente.h utils.h
	gcc -c -g $^

main.o: main.c utils.h ambiente.h render.h eventos.h barco.h
	gcc -c -g $^
